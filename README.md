...
- metadata with taxonomic info about phages (sylph_tax_metadata/all_phage_genomes_taxo.tsv).
- metadata with taxonomic info about bacteria (sylph_tax_metadata/uhgg2_metadata.tsv).
